...
const skillIcons: { [key: string]: ForwardRefExoticComponent<Omit<LucideProps, "ref"> & RefAttributes<SVGSVGElement>> | ((props: React.SVGProps<SVGSVGElement>) => JSX.Element) | string } = {
  ...
  'Next.js': (props: JSX.IntrinsicAttributes & SVGProps<SVGSVGElement>) => (
    <svg {...props} viewBox="0 0 128 128">
      ...
      <path fill="url(#nextjs-gradient)" d="M64 128C99.346 128 128 99.346 128 64C128 28.654 99.346 0 64 0C28.654 0 0 28.654 0 64C0 99.346 28.654 128 64 128Z"></path>
  ...
  'GraphQL': (props: JSX.IntrinsicAttributes & SVGProps<SVGSVGElement>) => (
    <svg {...props} viewBox="0 0 400 400">
      ...
      <path fill="url(#graphql-gradient)" d="m338 120.3-138 79.6-138-79.6L138 40.7l138 79.6zm-276.5 159L120.2 200l-58.7-33.9-61.4 35.5 61.4 35.5zm276.5 0L279.7 200l58.7-33.9 61.4 35.5-61.4 35.5zm-138.2 80l138-79.6 61.5-35.5-199.5 115.3L.5 243.8l61.5 35.5 138 79.6zM200 240.2l58.8 33.9-58.8 34-58.8-34 58.8-33.9zm-58.7-106.1L200 193l58.7-58.9-58.7-34-58.7 34zm-80.1 82l58.7-33.9 58.8 33.9-58.8 34-58.7-34zm218.8 0l-58.7-33.9-58.8 33.9 58.8 34 58.7-34zm-79.2-127.8l58.7 33.9-58.7 33.9-58.8-33.9 58.8-33.9z"></path>
    </svg>
  ),
