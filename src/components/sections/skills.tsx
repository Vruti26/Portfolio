...
const skillIcons: { [key: string]: ForwardRefExoticComponent<Omit<LucideProps, "ref"> & RefAttributes<SVGSVGElement>> | ((props: React.SVGProps<SVGSVGElement>) => JSX.Element) } = {
  ...
  'TypeScript': (props) => (
    <svg {...props} viewBox="0 0 128 128"><path fill="black" d="M0 0h128v128H0z"></path><path fill="white" d="M22.31 99.88V28.12h17.9v65.6h25.46v6.16H22.31zm52.3-64.8v6.17h25.46v58.63h17.9V35.08h-43.36zm-3.64-7.23c0-3.9 3.32-6.52 7.82-6.52s7.82 2.62 7.82 6.52c0 3.9-3.32 6.52-7.82 6.52s-7.82-2.62-7.82-6.52z"></path></svg>
  ),
  'Node.js': (props) => (
    <svg {...props} viewBox="0 0 256 256"><path fill="black" d="M211.59 187.822c-3.414-2.128-26.63-14.86-35.334-31.595l-8.423-16.323-38.358 22.012c-1.39 1.13-3.132 1.58-4.78 1.58-3.038 0-5.89-1.62-7.46-4.343l-34.93-60.19-38.356 22.01c-1.39 1.13-3.133 1.582-4.78 1.582-3.04 0-5.892-1.62-7.46-4.342L1.87 63.81c-2.12-3.66-0.34-8.312 3.9-9.74l37.89-12.56c3.27-1.086 6.77 0.416 8.52 3.268l24.78 42.662 45.45-26.096c2.4-1.74 5.39-2.22 8.16-1.42l37.892 12.56c4.238 1.43 5.998 6.08 3.89 9.74l-31.32 54.04 45.448-26.095c2.4-1.74 5.39-2.22 8.16-1.42l37.89 12.56c4.24 1.43 6.01 6.08 3.89 9.74l-52.54 90.54c-2.11 3.66-6.66 5.12-10.89 3.69z"></path></svg>
  ),
  'GraphQL': (props) => (
    <svg {...props} viewBox="0 0 400 400"><path fill="black" d="m338 120.3-138 79.6-138-79.6L138 40.7l138 79.6zm-276.5 159L120.2 200l-58.7-33.9-61.4 35.5 61.4 35.5zm276.5 0L279.7 200l58.7-33.9 61.4 35.5-61.4 35.5zm-138.2 80l138-79.6 61.5-35.5-199.5 115.3L.5 243.8l61.5 35.5 138 79.6zM200 240.2l58.8 33.9-58.8 34-58.8-34 58.8-33.9zm-58.7-106.1L200 193l58.7-58.9-58.7-34-58.7 34zm-80.1 82l58.7-33.9 58.8 33.9-58.8 34-58.7-34zm218.8 0l-58.7-33.9-58.8 33.9 58.8 34 58.7-34zm-79.2-127.8l58.7 33.9-58.7 33.9-58.8-33.9 58.8-33.9z"></path></svg>
  ),
  'UI/UX Design': DraftingCompass,
  'Figma': (props) => (
    <svg {...props} viewBox="0 0 64 96"><path fill="black" d="M32 64a16 16 0 1 1 0-32 16 16 0 0 1 0 32zM32 80a16 16 0 0 1-16-16h32a16 16 0 0 1-16 16z"></path><path fill="black" d="M16 48a16 16 0 0 1 16-16v32a16 16 0 0 1-16-16z"></path><path fill="black" d="M16 32a16 16 0 1 1 32 0 16 16 0 0 1-32 0z"></path><path fill="black" d="M16 16A16 16 0 0 1 32 0v32A16 16 0 0 1 16 16z"></path><path fill="black" d="M32 80a16 16 0 0 1 16-16v32a16 16 0 0 1-16-16z"></path></svg>
  ),
  'Firebase': Database,
};
